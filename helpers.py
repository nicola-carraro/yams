...
SCORE_ENTRIES = ["name", "ones", "twoes", "threes", "fours", "fives", "sixes", "bonus", "upper_total", "max", "min", "middle_total", "poker", "full", "small_straight", "large_straight", "yams", "rigole", "lower_total", "global_total" ]
